...
- สมัครสมาชิกด้วย email หรือเบอร์โทรศัพท์
- ยืนยันตัวตนด้วย OTP
- เข้าสู่ระบบ / ออกจากระบบ
- แยก role ผู้ใช้งาน (ผู้ป่วย / บุคลากร)

### 2.🧑‍⚕️ ระบบข้อมูลผู้ป่วย
- จัดการข้อมูลส่วนตัว (ชื่อ, วันเกิด, เพศ, เลขบัตรประชาชน)
- บันทึกข้อมูลที่อยู่
- บันทึกข้อมูลทางการแพทย์ (โรคประจำตัว, ยาที่ใช้, ประวัติแพ้ยา)
- บันทึกสิทธิการรักษา (บัตรทอง, ประกันสังคม, ข้าราชการ, ชำระเอง)
- ระบบ HN (Hospital Number) ประจำผู้ป่วย

### 3.📅 ระบบนัดหมาย
- จองนัดหมายพบแพทย์
- เลือกแพทย์ที่ต้องการ
- ระบุวันเวลานัด
- บันทึกเหตุผลการนัดและหมายเหตุ
- ติดตามสถานะนัดหมาย (จองแล้ว / มาถึง / เสร็จสิ้น / ยกเลิก)

### 4.🔢 ระบบคิว
- ออกหมายเลขคิว
- แบ่งห้องตรวจ (ห้อง A / ห้อง B)
- ติดตามสถานะคิว (รอ / กำลังตรวจ / เสร็จสิ้น / ข้าม)
- เชื่อมโยงคิวกับนัดหมาย

### 5.🖥️ ระบบบุคลากร (Web Admin)
- ดูและจัดการคิวทั้งหมด
- อัปเดตสถานะคิวผู้ป่วย
- ดูข้อมูลผู้ป่วย
- จัดการนัดหมาย
